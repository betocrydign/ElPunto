...
var orangethemesButtons=[
		...
		},
		{
			...
			generateHtml:function(obj){
				return '[ot-link url="'+obj.url+'"]'+obj.selection+'[/ot-link]';
			}
		...
		},		
		{
			...
			title:'Spacer',
			allowSelection:false,
			fields:[{id:'style', name:'Style', values:['Spacer 1', 'Spacer 2', 'Spacer 3']},{id:'icon', name:'Icon', values:ot_icons()},{id:'color', name:'Color', value:'8BC234', colorpalette:true}],
			generateHtml:function(obj){
		...
		},
		{
			...
			title:'Insert Video',
			allowSelection:false,
			fields:[{id:'links', name:'Video Embed Code', textarea:true }],
			generateHtml:function(obj){
				return '[ot-video]'+obj.links+'[/ot-video]';
			}
		},
		{
		...
		},
		{
			...
			title:'Alert Box',
			allowSelection:false,
			fields:[{id:'title', name:'Title'},{id:'text', name:'Text', textarea:true},{id:'color', name:'Color', color:"c24000", colorpalette:true},{id:'icon', name:'Icon', values:ot_icons()}],
			generateHtml:function(obj){
				
				return '[alert color="'+obj.color+'" icon="'+obj.icon+'" title="'+obj.title+'"]'+obj.text+'[/alert]';
