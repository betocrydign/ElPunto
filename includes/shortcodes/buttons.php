...
function button_handler($atts, $content=null, $code="") {
	extract(shortcode_atts(array('color' => null,'textcolor' => null,'icon' => null,'side' => null,), $atts) );
	...
	if($icon==false) {
		...
		$return = '<a href="'.$link.'" class="button" target="'.$target.'" style="background:#'.$color.'; color:#'.$textcolor.';">'.$content.'&nbsp;&nbsp;'.$icon.'</a>';
	}
