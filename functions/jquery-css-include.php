...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	function orange_themes_scripts() { 
		...
		wp_enqueue_style("animate", THEME_CSS_URL."animate.css", Array());
		...
		wp_enqueue_style("owl.theme", THEME_CSS_URL."owl.theme.css", Array());
		...
		wp_enqueue_script("snap.svg-min" , THEME_JS_URL."snap.svg-min.js", Array('jquery'), "1.5.19", true);
