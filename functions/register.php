	...
	if ( function_exists( 'register_nav_menus' ) ) {
		register_nav_menus(
			array( 
				...
				'seccond-menu' => __( 'Second Menu', THEME_NAME ),
				'logos-paginas' => __( 'Logos', THEME_NAME ),
			)
		);
	}	
}
...
function create_portfolio() {
	...
	$labels = array(
    'name' => _x('Portfolio', THEME_NAME),
    'singular_name' => _x('Portfolio Menu', THEME_NAME),
    'add_new' => _x('Add New', THEME_NAME),
    'add_new_item' => __('Add New Item', THEME_NAME),
    'edit_item' => __('Edit Item', THEME_NAME),
	...
	register_taxonomy(OT_POST_PORTFOLIO."-cat", 
					    	array(__("Portfolio Categories", THEME_NAME)), 
					    	array(	"hierarchical" => true, 
					    			"label" => __("Portfolio Categories", THEME_NAME), 
					    			"singular_label" => __("Portfolio Categories", THEME_NAME), 
					    			"rewrite" => true,
					    			"query_var" => true
					    		));  
		
		register_post_type( OT_POST_PORTFOLIO,
		array( 'labels' => $labels,
	         'public' => true,  
	         'show_ui' => true,  
	         'capability_type' => 'post',  
	         'hierarchical' => false,  
			 'taxonomies' => array(OT_POST_PORTFOLIO.'-cat'),
	         'supports' => array('title', 'editor', 'thumbnail', 'comments', 'page-attributes', 'excerpt') ) );
...
$orange_sidebars[] = array('name'=>'Banner Superior', 'id'=>'banner', 'description' => __('Top Banner', THEME_NAME));
$orange_sidebars[] = array('name'=>'Default Sidebar', 'id'=>'default','description' => __('The default page sidebar.', THEME_NAME));
$orange_sidebars[] = array('name'=>'Footer', 'id'=>'footer', 'description' => __('Footer widget area, supports up to 3 widgets.', THEME_NAME));
$orange_sidebars[] = array('name'=>'Footer2', 'id'=>'footer2', 'description' => __('Another Footer widget area, supports up to 3 widgets.', THEME_NAME));
if(function_exists('is_woocommerce')) {
	$orange_sidebars[] = array('name'=>'Woocommerce', 'id'=>'ot_woocommerce', 'description' => __('Woocommerce Page Sidebar', THEME_NAME));	
}
if(function_exists("is_bbpress")) {
	$orange_sidebars[] = array('name'=>'bbPress', 'id'=>'ot_bbpress', 'description' => __('bbPress Page Sidebar', THEME_NAME));
}
if(function_exists("is_buddypress")) {
	$orange_sidebars[] = array('name'=>'BuddyPress', 'id'=>'ot_buddypress', 'description' => __('BuddyPress Page Sidebar', THEME_NAME));	
}
if($stickySidebar=="on") {
