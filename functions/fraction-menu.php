			...
			array(
				"options" => array(
					...
					array(
						...
						"compare" => get_option(THEME_NAME.'_post_style'),
					),
					array(
						"type" => "title",
					...
					array(
						...
						"radio" => array(
							array("title" => __("Large:", THEME_NAME), "value" => "show"),
							array("title" => __("Small:", THEME_NAME), "value" => "hide")
						),
						"std" => 'show',
						"page_type" => array("post"),
						"compare" => get_option(THEME_NAME.'_post_style'),
					...
					array(
						"type" => "title",
						"title" => __("Post Author", THEME_NAME),
						"page_type" => array("post")
					),
					array(
						"type" => "radio",
					...
					array(
						"type" => "row",
						"page_type" => array("post",OT_POST_GALLERY),
					...
					array(
						"type" => "title",
						"title" => __("Show Post Comments Count", THEME_NAME),
						"page_type" => array("post")
					),
					array(
						"type" => "radio",
					...
					array(
						"type" => "title",
						"title" => __("\"Similar News\" Block In Gallery", THEME_NAME),
						"page_type" => array(OT_POST_GALLERY)
					),
					array(
						"type" => "radio",
					...
					array(
						"type" => "row",
						"page_type" => array(OT_POST_PORTFOLIO),
						"compare" => get_option(THEME_NAME.'_similar_posts_portfolio'),
					),
					array(
						"type" => "title",
						"title" => __("\"Similar News\" Block In Portfolio", THEME_NAME),
						"page_type" => array(OT_POST_PORTFOLIO)
					),
					array(
						"type" => "radio",
					...
					array(
						"type" => "title",
						"title" => __("Show Main Slider?", THEME_NAME),
						"page_type" => array("homepage"),
					),
					array(
						"type" => "multiple_select",
					...
					array(
						"type" => "input",
						"title" => __("Subtitle:", THEME_NAME),
						"id" => "_".$orangeThemes_meta_fields->themeslug."_subtitle",
						"page_type" => array("page")
					),
					...
					array(
						"type" => "title",
						"title" => __("Homepage Posts", THEME_NAME),
						"page_type" => array("homepage")
					),
					array(
						"type" => "multiple_select",
						"title" => __("Set Home News Categories", THEME_NAME),
						"id" => "_".$orangeThemes_meta_fields->themeslug."_home_news",
						"taxonomy" => "category",
						"std" => 'slider_off',
						"page_type" => array("homepage")
					),
					...
					array(
						"type" => "title",
						"title" => __("Spotlight", THEME_NAME),
						"page_type" => array( "post")
					),
					array(
						"type" => "input",
						"title" => __("Spotlight Post ID's:", THEME_NAME),
						"info" => __("Add post ID that you want to see in Spotlight, separate them with ,<br/>Example: 1,2,5", THEME_NAME),
						"id" => "_".$orangeThemes_meta_fields->themeslug."_spotlight",
						"page_type" => array("post")
					),
					...
					array(
						"type" => "title",
						"title" => __("Image Hover Icon", THEME_NAME),
						"page_type" => array( "post")
					),
					array(
						"type" => "icon_select",
						"title" => __("Icon:", THEME_NAME),
						"id" => "_".$orangeThemes_meta_fields->themeslug."_image_icon",
						"page_type" => array("post")
					),
					array(
						"type" => "input",
						"title" => __("Text Under the Image Icon:", THEME_NAME),
						"id" => "_".$orangeThemes_meta_fields->themeslug."_image_text",
						"page_type" => array("post")
					),
					array(
						"type" => "close",
					...
					array(
						"type" => "title",
						"title" => __("Video/Audio Embed Code", THEME_NAME),
						"page_type" => array("post")
					),
					array(
						"type" => "textarea",
						"title" => __("Vimeo, Youtube, Soundcould or Mixcould Embed Code:",THEME_NAME),
					...
					array(
						"type" => "textarea",
						"title" => __("Embed Code:", THEME_NAME),
					...
					array(
						"type" => "title",
						"title" => __("Post Banner", THEME_NAME),
						"page_type" => array("post")
					),
					array(
						"type" => "textarea",
						"title" => __("Post Banner HTML Code",THEME_NAME),
						"id"=> '_'.$orangeThemes_meta_fields->themeslug."_post_banner_code",
						"page_type" => array("post")
					),	
					array(
						"type" => "close",
					...
					array(
						"type" => "title",
						"title" => __("Project Date", THEME_NAME),
						"page_type" => array(OT_POST_PORTFOLIO)
					),
					array(
						"type" => "datepicker",
						"title" => __("Date",THEME_NAME),
						"id"=> '_'.$orangeThemes_meta_fields->themeslug."_date",
						"page_type" => array(OT_POST_PORTFOLIO)
					),	
					array(
						"type" => "close",
					...
					array(
						"type" => "title",
						"title" => __("Features", THEME_NAME),
						"page_type" => array(OT_POST_PORTFOLIO)
					),
					array(
						"type" => "textarea",
						"title" => __("Feautres",THEME_NAME),
						"info" => __("Separate each feature with ;",THEME_NAME),
						"id"=> '_'.$orangeThemes_meta_fields->themeslug."_features",
						"page_type" => array(OT_POST_PORTFOLIO)
					),	
					array(
						"type" => "close",
					...
					array(
						"type" => "title",
						"title" => __("Button", THEME_NAME),
						"page_type" => array(OT_POST_PORTFOLIO)
					),
					array(
						"type" => "input",
						"title" => __("Button Title",THEME_NAME),
						"id"=> '_'.$orangeThemes_meta_fields->themeslug."_btnTitle",
						"page_type" => array(OT_POST_PORTFOLIO)
					),	
					array(
						"type" => "input",
						"title" => __("Button Subtitle",THEME_NAME),
						"id"=> '_'.$orangeThemes_meta_fields->themeslug."_btnSubtitle",
						"page_type" => array(OT_POST_PORTFOLIO)
					),		
					array(
						"type" => "input",
						"title" => __("Button Url",THEME_NAME),
						"id"=> '_'.$orangeThemes_meta_fields->themeslug."_btnUrl",
						"page_type" => array(OT_POST_PORTFOLIO)
					),		
					array(
						"type" => "input",
						"title" => __("Price",THEME_NAME),
						"id"=> '_'.$orangeThemes_meta_fields->themeslug."_price",
						"page_type" => array(OT_POST_PORTFOLIO)
					),	
					array(
						"type" => "close",
					...
					array(
						"type" => "title",
						"title" => __('Main Sidebar Side', THEME_NAME),
					),
					array(
						"type" => "radio",
					...
					array(
						"type" => "title",
						"title" => __('Main Sidebar Name', THEME_NAME),
					),
					array(
						"type" => "sidebar_select",
					...
					array(
						"type" => "title",
						"title" => __('Second Sidebar Side', THEME_NAME),
					),
					array(
						"type" => "radio",
					...
					array(
						"type" => "title",
						"title" => __('Second Sidebar Name', THEME_NAME),
					),
					array(
						"type" => "sidebar_select",
						"title" => __('Sidebar', THEME_NAME),
...
$box_array[] = array('id' => 'post-1','title' => ''.$image.__("Reviews Block Image", THEME_NAME),'page' => 'post', 'context' => 'side','priority' => 'low','fields' => array(array('name' => __("Image:", THEME_NAME),'std' => '','id' => $prefix. 'reviews_image','type'=> 'slider_image_box')),'size' => 10,'first' => 'no');
...
//portfolio images
$box_array[] = array( 'id' => 'post-slider-images', 'title' => ''.$image.__("Portfolio Images", THEME_NAME), 'page' => OT_POST_PORTFOLIO, 'context' => 'side', 'priority' => 'low', 'fields' => array(array('name' => __("", THEME_NAME), 'std' => '', 'id' => $prefix. 'portfolio_images', 'type'=> 'image_select' ) ), 'size' => 0,'first' => 'no'  );
