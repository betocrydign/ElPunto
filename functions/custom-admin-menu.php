        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="field-custom description description-wide">
                <label for="edit-menu-menu_type-<?php echo $item_id; ?>">
                    <?php _e( 'Main menu type ( only menu parent item, more info <a href="http://fraction.orange-themes.com/documentation/#mega-menu" target="_blank">here</a> )', THEME_NAME ); ?><br/>
                    <select id="edit-menu-menu_type-<?php echo $item_id; ?>" name="menu-item-menu_type[<?php echo $item_id; ?>]">
                        ...
                        <option value="2"<?php if($item->menu_type=="2") echo ' selected="selected"'; ?>><?php _e('Mega Menu With Posts', THEME_NAME ); ?></option>
                        <option value="3"<?php if($item->menu_type=="3") echo ' selected="selected"'; ?>><?php _e('Mega Menu With Widgets', THEME_NAME ); ?></option>
                    </select>
                </label>
            </p>     
            <p class="field-custom description description-wide ot-sidebar-field">
                <label for="edit-menu-menu_sidebar-<?php echo $item_id; ?>">
                    <?php _e( 'Sidebar for widget mega menu', THEME_NAME ); ?><br/>
                    <?php 
                        $sidebar_names = get_option( THEME_NAME."_sidebar_names" );
                        $sidebar_names = explode( "|*|", $sidebar_names );
                    ?>
                    <select id="edit-menu-menu_sidebar-<?php echo $item_id; ?>" name="menu-item-menu_sidebar[<?php echo $item_id; ?>]">
                        <option value="default" ><?php _e("Default", THEME_NAME);?></option>
                        <?php
